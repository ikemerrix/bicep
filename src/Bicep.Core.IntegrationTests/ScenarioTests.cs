...
",
            ...
            jsonOutput.Should().Contain("[reference(resourceId('vnet-rg', 'Microsoft.Resources/deployments', 'network-module'), '2019-10-01').outputs.vnetId.value]");
            jsonOutput.Should().Contain("[reference(resourceId('vnet-rg', 'Microsoft.Resources/deployments', 'network-module'), '2019-10-01').outputs.vnetstate.value]");
        }
    }
}